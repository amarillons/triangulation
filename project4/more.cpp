...
void placeVertex3(){
  ...
  v1.x = -1.; v1.y = 7.; Vertices.push_back(v1);
  // v1.x = -5.; v1.y = 7.5; Vertices.push_back(v1);
  v1.x = -1.; v1.y = 0.5; Vertices.push_back(v1);
  v1.x = 2.; v1.y = 1.0; Vertices.push_back(v1);
  v1.x = 0.5; v1.y = -5.0; Vertices.push_back(v1);
  v1.x = 4.5; v1.y = 5.0; Vertices.push_back(v1);
  // v1.x = 3.; v1.y = 0.; Vertices.push_back(v1);
  // v1.x = 1.; v1.y = -2.; Vertices.push_back(v1);
  // v1.x = 1.; v1.y = 5.; Vertices.push_back(v1);
  // v1.x = 4.; v1.y = 7.; Vertices.push_back(v1);
  // v1.x = 5.; v1.y = 7.5; Vertices.push_back(v1);
