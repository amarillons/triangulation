...
void getDelaunayTriangles(){

  std::vector<class Vertex>::iterator it_v1;
  it_v1 = Vertices.begin();
  while(it_v1!=Vertices.end()){

    Vertex newV = *it_v1;

    std::vector<class Triangle>::iterator it_t1;
    it_t1 = Triangles.begin();
    while(it_t1!=Triangles.end()){
	
      Triangle parentT = *it_t1;

      if(containsTheVertex(parentT,newV)){

	Triangle t1,t2,t3;
	
	// t1.p1 = newVertex; t1.p2 = parentT.p1; t1.p3 = parentT.p2;
	// t2.p1 = newVertex; t2.p2 = parentT.p2; t2.p3 = parentT.p3;
	// t3.p1 = newVertex; t3.p2 = parentT.p1; t3.p3 = parentT.p3;
      }
      it_t1++;
    }
    it_v1++;
...
int main(){
  ...
  t1.p1.x = newV.x; t1.p2.x = parentT.p1.x; t1.p3.x = parentT.p3.x;
  t1.p1.y = newV.y; t1.p2.y = parentT.p1.y; t1.p3.y = parentT.p3.y;
  Triangles.push_back(t1);
